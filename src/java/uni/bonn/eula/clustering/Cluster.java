...
package uni.bonn.eula.clustering;
...
public class Cluster
{
    ...
    public String returnLeaves()
    {
        return returnLeaves(this, "");
    }

    public String returnLeaves(Cluster node, String allLeaves)
    {
    	if (node.isLeaf()){
    		allLeaves = node.getName() + ","; 
    	}
        for (Cluster child : node.getChildren())
        {
        	allLeaves += child.returnLeaves();
        }
        return allLeaves;
    }    
